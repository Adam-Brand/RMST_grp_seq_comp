...
for (k in 1:length(ss)){
     ...
     filetmp <- paste("PH.ss",ss[k],"nofut.trteff",bstar,"allcov.age.fem.LTFU",LTFU,"times",rm.times,".rds",sep="")
     
     saveRDS(result, file=paste("Results","sim2grpseqtype1", filetmp, sep="/"))
...
for (k in 1:length(ss)){
     ...
     filetmp <- paste("PH.ss",ss[k],"nofut.trteff",bstar,"nocov.fem.age.LTFU",LTFU,"times",rm.times,".rds",sep="")
