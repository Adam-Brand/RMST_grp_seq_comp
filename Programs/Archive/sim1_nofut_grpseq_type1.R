...
for (k in 1:length(ss)){
     ...
     filetmp <- paste("PH.ss",ss[k],"nofut.trteff",bstar,"allcov.nocoef.LTFU",LTFU,"times",rm.times,".rds",sep="")
     
     saveRDS(result, file=paste("Results","sim1grpseqtype1", filetmp, sep="/"))
...
for (k in 1:length(ss)){
     ...
     filetmp <- paste("PH.ss",ss[k],"nofut.trteff",bstar,"nocov.nocoef.LTFU",LTFU,"times",rm.times,".rds",sep="")
